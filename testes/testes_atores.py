...
class PassaroAmareloTests(PassaroBaseTests):
    ...
    def test_lancamento_45_graus(self):
        ...
        self.assert_passaro_posicao(3, 3, ATIVO, passaro_amarelo, 2.12)
        ...
        self.assert_passaro_posicao(4, 4, ATIVO, passaro_amarelo, 2.17)
        ...
        self.assert_passaro_posicao(5, 5, ATIVO, passaro_amarelo, 2.22)
        ...
        self.assert_passaro_posicao(6, 6, ATIVO, passaro_amarelo, 2.26)
        self.assert_passaro_posicao(6, 6, ATIVO, passaro_amarelo, 2.27)
        ...
        self.assert_passaro_posicao(7, 7, ATIVO, passaro_amarelo, 2.31)
        self.assert_passaro_posicao(7, 7, ATIVO, passaro_amarelo, 2.32)
        self.assert_passaro_posicao(7, 7, ATIVO, passaro_amarelo, 2.33)
        self.assert_passaro_posicao(8, 8, ATIVO, passaro_amarelo, 2.34)
        self.assert_passaro_posicao(8, 8, ATIVO, passaro_amarelo, 2.35)
        self.assert_passaro_posicao(8, 8, ATIVO, passaro_amarelo, 2.36)
        self.assert_passaro_posicao(9, 9, ATIVO, passaro_amarelo, 2.37)
        self.assert_passaro_posicao(9, 9, ATIVO, passaro_amarelo, 2.38)
